...
export function SimbolosLadder() {
  ...
  const bobinas: Array<[ReactNode, string, string]> = [
    ...
    [bobina('S'), 'Set (L, latch)', 'Con corriente: a 1, y se queda así hasta que un Reset la apague. Sin corriente: sigue igual.'],
    [bobina('R'), 'Reset (U, unlatch)', 'Con corriente: a 0, y se queda así hasta un Set. Sin corriente: sigue igual.'],
